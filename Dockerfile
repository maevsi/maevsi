...
FROM node:14.15.4-buster@sha256:0d8bb4eb7c6bcdf88003e942c294dabb37b143d3199696b5eebd8c0a91dc33b0 AS development
...
# `node-zopfli-es` and `sqitch` require at least buster.
# `node-zopfli-es` requires non-slim.
FROM node:14.15.4-buster@sha256:0d8bb4eb7c6bcdf88003e942c294dabb37b143d3199696b5eebd8c0a91dc33b0 AS build
