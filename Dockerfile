...
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS development
...
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS prepare
...
# Should be the specific version of `node:slim`.
# Could be the specific version of `node:alpine`, but the `prepare` stage uses slim too.
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS build
...
# Should be the specific version of `node:slim`.
# Could be the specific version of `node:alpine`, but the `prepare` stage uses slim too.
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS lint
...
# Should be the specific version of `node:slim`.
# Could be the specific version of `node:alpine`, but the `prepare` stage uses slim too.
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS test
...
# Should be the specific version of `node:slim`.
# Could be the specific version of `node:alpine`, but the `prepare` stage uses slim too.
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS test-integration
...
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS test-visual
...
# Should be the specific version of node:slim.
# `storycap` requires Debian.
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS test-visual_standalone
...
# Should be the specific version of node:slim.
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS collect
...
# Should be the specific version of node:slim.
# `sqitch` requires at least `buster`.
FROM node:18.7.0-slim@sha256:3a83bba6aff12b9c2966155b0e3e342302f3763406f5562605f560ee1cd7225b AS production
