...
export const EVENT_DESCRIPTION_LENGTH_MAXIMUM = 10000
export const EVENT_LOCATION_LENGTH_MAXIMUM = 300
export const EVENT_NAME_LENGTH_MAXIMUM = 100
export const EVENT_SLUG_LENGTH_MAXIMUM = 100
...
export default async ({ app, req, res, store }, inject) => {
  const global = {
    ...
    EVENT_DESCRIPTION_LENGTH_MAXIMUM,
    EVENT_LOCATION_LENGTH_MAXIMUM,
    EVENT_NAME_LENGTH_MAXIMUM,
    EVENT_SLUG_LENGTH_MAXIMUM,
