...
CREATE TABLE maevsi.contact (
  ...
  account_id            BIGINT REFERENCES maevsi_private.account(id) ON DELETE CASCADE UNIQUE,
...
COMMENT ON COLUMN maevsi.contact.account_id IS 'The contact''s internal account id.';
